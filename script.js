...
function handleFavBtn(e, details) {
    e.preventDefault();
    ...
    if (tempData) {
      ...
      favMoviesInfo.unshift(details);
      localStorage.setItem("favourite movies", JSON.stringify(favMoviesInfo));
    } else {
      localStorage.setItem("favourite movies", JSON.stringify(details));
    }
  }
...
function displayMovieDetails(details){
    ...
    <div class = "movie-info">
        ...
        <button id="fav_btn" class="btn btn-danger" type="submit" onclick="changeText()">Add to My fav</button>
    </div>
    `;
    ...
    document
        ...
        .addEventListener("click", (e) => handleFavBtn(e, details));
...
function changeText(){ 
    document.getElementById('fav_btn').innerHTML = "Added Successfully!!"
}
